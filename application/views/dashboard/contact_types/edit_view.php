  ...
  <div class="col-lg-4 col-lg-offset-4">
    ...
    ?>
      <div class="form-group">
        ...
        echo form_input('title',set_value('title',$contact_type->title),'class="form-control"');
        ?>
      </div>
      <div class="form-group">
        <?php
        ...
        echo form_textarea('info',set_value('info',$contact_type->info),'class="form-control"');
        ?>
      </div>
      <?php
      echo form_error('id');
      echo form_hidden('id',$contact_type->id);
