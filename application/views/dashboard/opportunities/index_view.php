    ...
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#new" aria-controls="home" role="tab"
                                                      data-toggle="tab"><?php echo $this->lang->line('new_tab_title'); ?>
                    <span class="badge"><?php echo(($opportunities !== FALSE) ? sizeof($opportunities) : '0'); ?></span></a>
            </li>
            <li role="presentation"><a href="#my" aria-controls="profile" role="tab"
                                       data-toggle="tab"><?php echo $this->lang->line('my_tab_title'); ?> <span
                            class="badge"><?php echo(($my_opportunities !== FALSE) ? sizeof($my_opportunities) : '0'); ?></span></a>
            </li>
            <li role="presentation"><a href="#unread" aria-controls="profile" role="tab"
                                       data-toggle="tab"><?php echo $this->lang->line('unread_tab_title'); ?> <span
                            class="badge"<?php echo(($unread_opportunities !== FALSE) ? ' style="background:red;"' : ''); ?>><?php echo(($unread_opportunities !== FALSE) ? sizeof($unread_opportunities) : '0'); ?></span></a>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 10px;">
                        ...
                        if ($opportunities) {
                            ...
                            echo '<tr><td>' . $this->lang->line('table_id_field') . '</td><td>' . $this->lang->line('table_contact_field') . '</td><td>' . $this->lang->line('table_email_field') . '</td><td>' . $this->lang->line('table_phone_field') . '</td><td>' . $this->lang->line('table_title_field') . '</td><td>' . $this->lang->line('table_source_field') . '</td><td>' . $this->lang->line('table_status_field') . '</td><td>' . $this->lang->line('table_operations_field') . '</td></tr>';
                            foreach ($opportunities as $opportunity) {
                                echo '<tr>';
                                echo '<td>' . $opportunity->id . '</td>';
                                echo '<td>' . $opportunity->contact->first_name . ' ' . $opportunity->contact->last_name . '</td>';
                                echo '<td>' . $opportunity->contact->email . '</td>';
                                echo '<td>' . $opportunity->contact->phone . '</td>';
